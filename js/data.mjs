export const data = {
  ...
  page2: {
    media: {
      src: "/assets/technomaze.png",
      alt: "Visit Technomaze a crazy blog website covering all bs stuff",
    },
    title: "Technomaze",
  ...
  page3: {
    media: {
      src: "/assets/squareeyes.png",
      alt: "Image description for Page 3",
    },
    title: "Square Eyes",
  ...
  /*
    pageX: {
      media: {
        src: "/assets/imgX.png", // Local asset
        alt: "Image description for Page X"
      },
      title: "Page X Title",
